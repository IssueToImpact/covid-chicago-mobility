...
def process_targets(df, start_date='2020-03-23', end_date='2020-05-03'):
    ...
    total_time_away = get_total_time_away(df)
    df['fraction_time_away_all'] = total_time_away/(1440*df['device_count'])
    df['fraction_time_away_leave'] = total_time_away/(1440*(df['device_count'] - df['completely_home_device_count']))
